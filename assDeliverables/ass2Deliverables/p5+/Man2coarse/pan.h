...
#define PanSource	"Man2coarse.pml"
...
#define nstates0	45	/* Car */
#define endstate0	44
short src_ln0 [] = {
	  0,  46,  25,  26,  26,  26,  27,  28, 
	 28,  28,  24,  30,  30,  54,  54,  55, 
	 55,  53,  57,  52,  58,  61,  61,  62, 
	 62,  60,  64,  59,  34,  35,  36,  37, 
	 33,  39,  39,  70,  70,  70,  70,  71, 
	 70,  46,  72,  46,  72,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "Man2coarse.pml", 1, 44 },
