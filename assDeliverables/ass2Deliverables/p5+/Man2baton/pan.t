...
{	Trans *T;
	...
	trans[0][1]	= settr(0,0,60,1,0,"(1)", 0, 2, 0);
	T = trans[ 0][60] = settr(59,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(59,0,58,0,0,"sub-sequence", 0, 2, 0);
	...
	T = T->nxt	= settr(113,0,111,0,0,"DO", 0, 2, 0);
	    T->nxt	= settr(113,0,113,0,0,"DO", 0, 2, 0);
	trans[0][111]	= settr(110,0,112,1,0,"(1)", 0, 2, 0);
	trans[0][112]	= settr(111,0,114,1,0,"(1)", 0, 2, 0);
