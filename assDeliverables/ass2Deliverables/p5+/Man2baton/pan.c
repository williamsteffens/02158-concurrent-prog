...
iniglobals(void)
{
		...
		now.ddown = 0;
#ifdef VAR_RANGES
		logval("eSem", now.eSem);
		logval("upSem", now.upSem);
		logval("downSem", now.downSem);
		logval("inAlleyUp", now.inAlleyUp);
		logval("inAlleyDown", now.inAlleyDown);
		logval("up", now.up);
...
{	/* int i; */
	...
	printf("	bit    eSem:	%d\n", now.eSem);
	printf("	bit    upSem:	%d\n", now.upSem);
	printf("	bit    downSem:	%d\n", now.downSem);
	printf("	short  up:	%d\n", now.up);
	printf("	short  down:	%d\n", now.down);
	printf("	short  dup:	%d\n", now.dup);
	printf("	short  ddown:	%d\n", now.ddown);
	printf("	byte   inAlleyUp:	%d\n", now.inAlleyUp);
	printf("	byte   inAlleyDown:	%d\n", now.inAlleyDown);
}
void
