 ...
 */
class SearchTask1 implements Callable<List<Integer>> {
     ...
     * text[from..(to-1)]
     */
    public SearchTask1(char[] text, char[] pattern, int from, int to) {
        this.text = text;
...
public class Search1 {
    ...
    public static void main(String[] argv) {
        try {
             ...
             *********************************************/
            SearchTask1 singleSearch = new SearchTask1(text, pattern, 0, len);
            ...
            List<SearchTask1> taskList = new ArrayList<>();
            ...
            */
            ...
            for (u = 0; u < ntasks - 1; ++u)
                taskList.add(new SearchTask1(text, pattern, u * partition, (u + 1) * partition + pattern.length - 1));
            taskList.add(new SearchTask1(text, pattern, u * partition, len));
